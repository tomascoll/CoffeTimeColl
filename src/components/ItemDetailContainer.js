...
const cafeBD = [
  {
    ...
    categoria: "reserve",
    stock: 10,
    descripcion:'White Peach, Hazelnut & Citrus Zest Located on the south side of the Big Island, Ka‘u is home to black-sand beaches and a close-knit coffee community. Stepping out of the shadow of its neighbor, Kona, Ka‘u has become a coveted micro-origin.',
    image:
